...
<body>
	...
	<section class="">
		...
		?>
			...
			<h2 class="caption" style="text-align: center"><i>Temukan mobil untuk di sewa!</i></h2>
	...
	<section class="listings">
		<div class="wrapper">
			...
			?>
				...
				<h3>Lanjutkan penyewaan <?php echo $rws['car_name'];?>. </h3>
				<?php
				...
				<?php
						...
						{
							?>
								<a href="pay.php">Tekan untuk menyewa</a>
							<?php
						}
				?>
				<?php
